...
if [ -f ~/.bash_completion.d/tmuxinator.bash ]; then
    . ~/.bash_completion.d/tmuxinator.bash
fi
...
# 2013/01/23 sherman hsu
# Envoirnment variable for gcc message in terminal
export LC_MESSAGES=C

# 2014/04/24 sherman hsu
